...
import com.zachvoxwattz.core.misc.LogServiceType;
...
public class LogService {
    ...
    public static void logInfo(String message, Object... args) { if (!isInitialized) initialize(); logConsole(message, LogServiceType.INFO, args); }
    public static void logDebug(String message, Object... args) { if (!isInitialized) initialize(); logConsole(message, LogServiceType.DEBUG, args); }
    public static void logWarning(String message, Object... args) { if (!isInitialized) initialize(); logConsole(message, LogServiceType.WARNING, args); }
    public static void logError(String message, Object... args) { if (!isInitialized) initialize(); logConsole(message, LogServiceType.ERROR, args); }
    public static void logCritical(String message, Object... args) { if (!isInitialized) initialize(); logConsole(message, LogServiceType.CRITICAL, args); }
